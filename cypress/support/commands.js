...
const wrongEmail = "thisisatest1234_@stud.noroff.no";
const email = "bomboclat@stud.noroff.no";
const password = "bomboclat123";
...
Cypress.Commands.add("loginCorrectUser", () => {
...
Cypress.Commands.add("browserAlert", () => {
